...
import scrapy
from scrapy_IR.items import IrScrapyItem
...
class SinhalaLyrics(scrapy.Spider):
    ...
    start_urls = ['https://sinhalasongbook.com/all-sinhala-song-lyrics-and-chords/?_page=' + str(i) for i in range(22,23)]            # max range(1, 23)
